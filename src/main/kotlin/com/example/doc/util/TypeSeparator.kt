...
class TypeSeparator {
    companion object {
        ...
        fun getObjCollection(field: Field): Class<*> {
            return if(collectionMaps.contains(field.type)){
                (field.genericType as ParameterizedType).actualTypeArguments[1] as Class<*>
            } else {
                (field.genericType as ParameterizedType).actualTypeArguments.first() as Class<*>
            }
        }
